  ...
  var factory = function (exports) {
    ...
    exports.fn.imageDialog = function() {
      ...
      if (editor.find("." + dialogName).length < 1)
      {
        ...
        var dialogContent = ( (settings.imageUpload) ? "<form " +"\" target=\"" + iframeName + "\" method=\"post\" enctype=\"multipart/form-data\" class=\"" + classPrefix + "form\">" : "<div class=\"" + classPrefix + "form\">" ) +
          ( (settings.imageUpload) ? "<div name=\"" + iframeName + "\" id=\"" + iframeName + "\" guid=\"" + guid + "\"></div>" : "" ) +
          "<label>" + imageLang.url + "</label>" +
          "<input type=\"text\" data-url />" + (function(){
            return (settings.imageUpload) ? "<div class=\"" + classPrefix + "file-input\">" +
              "<input type=\"file\" id=\"imageId\" name=\"" + classPrefix + "image-file\" accept=\"image/*\" />" +
        ...
        fileInput.bind("change", function() {
          ...
          var submitHandler = function() {
            ...
            var uploadIframe = document.getElementById('imageId');
