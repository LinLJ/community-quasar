<template>
  <div class="guide-container">
    ...
    <div class="faq-part">
      ...
      <div class="content">你提问前有在我们的 搜索栏 先行搜索过吗？使用搜索，能更快地帮你找到答案。即使没找到，在看了相关或者类似的问题之后，你的提问会更准确。</div>
    </div>
    ...
    <q-btn type="primary" class="search-btn" @click="handleSearch">搜索</q-btn>
    </div>
    ...
    <div class="faq-part">
      ...
      <div class="content">或许最后得到的答案并不是你最想要的，但深思熟虑过的问题依旧可能会让你有其他方面的收获。每个人的成长都是一步步来的，所以，Keep an open mind。</div>
    </div>
    <div class="container-footer">
      <q-btn type="primary" class="qa-button" @click="goAskAQues">我已知晓，继续提问</q-btn>
    </div>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    handleSearch() {
      this.$router.push({ path: '/search', query: { category: 'all', keyword: this.search }})
    },
    goAskAQues() {
      setTimeout(() => {
