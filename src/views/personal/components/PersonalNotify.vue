<template>
  <tdf-scroll-load :on-touch-bottom="geNotifyes" :is-loaded-all="allLoaded" class="width-auto">
    <div
...
<script>
import { geNotifyes, notifyRead } from '@/api/personal'
...
export default {
  ...
  methods: {
    geNotifyes() {
      return geNotifyes(this.listQuery).then(response => {
